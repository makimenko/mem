...
public class GameApiController implements GameApi {
    ...
    public ResponseEntity<Game> gameNewPost(@ApiParam(value = "Game Options" ,required=true )  @Valid @RequestBody GameOption gameOption) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Game>(objectMapper.readValue("\"\"", Game.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
